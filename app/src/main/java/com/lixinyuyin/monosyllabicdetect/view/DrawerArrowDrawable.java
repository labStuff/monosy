...
public class DrawerArrowDrawable extends Drawable {
    ...
    /**
     * Joins two {@link Path}s as if they were one where the first 50% of the path is
     * {@code PathFirst} and the second 50% of the path is {@code pathSecond}.
     */
    private static class JoinedPath {
        ...
        /**
         * Returns a point on this curve at the given {@code parameter}. For {@code parameter}
         * values less than .5f, the first path will drive the point. For {@code parameter} values
         * greater than .5f, the second path will drive the point. For {@code parameter} equal to
         * .5f, the point will be the point where the two internal paths connect.
         */
    ...
    private class BridgingLine {
        ...
        /**
         * Insets the end points of the current line to account for the protruding ends drawn for
         * {@link Cap#ROUND} style lines.
         */
    ...
    /**
     * When false, rotates from 3 o'clock to 9 o'clock between a drawer icon and a back arrow. When
     * true, rotates from 9 o'clock to 3 o'clock between a back arrow and a drawer icon.
     */
