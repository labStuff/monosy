package com.lixinyuyin.monosyllabicdetect.view.slider;
...
public class Slider extends CustomView {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY =
                                Utils.getRelativeTop(this) - getHeight() / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == min) {
            ...
            temp.drawCircle(ViewHelper.getX(ball) + ball.getWidth() / 2, ViewHelper.getY(ball)
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        showNumberIndicator =
                attrs.getAttributeBooleanValue(MATERIALDESIGNXML, "showNumberIndicator", false);
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (numberIndicatorResize == false) {
                RelativeLayout.LayoutParams params =
                        (LayoutParams) numberIndicator.numberIndicator.getLayoutParams();
                ...
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        + Utils.getRelativeLeft((View) ball.getParent()) + ball
                                        .getWidth() / 2) - size);
    ...
    class NumberIndicator extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.tch_number_indicator_spinner);
            setCanceledOnTouchOutside(false);

            RelativeLayout content =
                    (RelativeLayout) this.findViewById(R.id.number_indicator_spinner_content);
